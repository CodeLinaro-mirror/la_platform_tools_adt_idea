...
import com.android.tools.idea.editors.hprof.HprofBitmapEvaluator;
...
public class ViewBitmapAction extends AnAction {
  @Override
  public void update(AnActionEvent e) {
    ...
    if (selectedClassInstance != null) {
      boolean isBitmap = HprofBitmapEvaluator.canGetBitmapFromInstance(selectedClassInstance);
      if (isBitmap) {
        presentation.setEnabled(true);
        presentation.setIcon(ImagesIcons.ImagesFileType);
        presentation.setText(AndroidBundle.message("android.profiler.hprof.actions.view.bitmap"));
        return;
      }
    }
  ...
  public void actionPerformed(AnActionEvent e) {
    ...
    BufferedImage img = HprofBitmapEvaluator.getBitmap(selectedClassInstance);
